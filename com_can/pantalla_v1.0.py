...
SIG_FUEL_PRESS = {'off': 4, 'len': LEN_16BIT, 'mask': MASK_16BIT, 'mult': MULT_BASE, 'div': DIV_BASE, 'add': ADD_BASE}
SIG_OIL_PRESS  = {'off': 6, 'len': LEN_16BIT, 'mask': MASK_16BIT, 'mult': MULT_BASE, 'div': DIV_BASE, 'add': ADD_BASE}
...
try:
    ...
    while True:
        ...
        payload_640 = [0] * 8 
        payload_640 = preparar_payload(payload_640, 4500, SIG_RPM) 
        payload_640 = preparar_payload(payload_640, 85, SIG_TPS) 
        ...
        # --- TEMPERATURAS (0x649) ---
        payload_649 = [0] * 8 
        payload_649 = preparar_payload(payload_649, 95, SIG_COOLANT) 
        payload_649 = preparar_payload(payload_649, 110, SIG_OIL) 
        payload_649 = preparar_payload(payload_649, 30, SIG_FUEL) 
