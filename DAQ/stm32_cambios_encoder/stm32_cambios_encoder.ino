...
//
//  Estructura del paquete (13 bytes):
//  [0]      → 0xAA         (sync byte)
//  [1..4]   → cambio       (int32_t,  4 bytes)
//  [5..8]   → angulo       (float,    4 bytes)
//  [9..12]  → tiempo_us    (uint32_t, 4 bytes)
//
//  Del lado Python (Raspberry Pi):
//    STM32_TAM_PKT = 13
//    STM32_FORMATO = '<ifI'   # cambio (int32), angulo (float), tiempo_us (uint32)
//====================================================
#define MAX_DATOS 13   // 1 sync + 1×4 int32 + 1×4 float + 1×4 uint32
