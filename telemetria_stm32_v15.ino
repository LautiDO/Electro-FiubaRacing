...
//
//  Estructura del paquete (69 bytes):
//  [0]      → 0xAA  (sync byte)
...
//  [65..68] → tiempo_us      (uint32_t, 4 bytes)
//====================================================
#define MAX_DATOS 69   // 1 sync + 15×4 float + 1×4 int32 + 1×4 uint32
...
//                      LOOP
//====================================================
const uint32_t PERIODO_MUESTREO_US = 200000; // 20.000 us = 50 Hz
...
void loop() {
  ...
  //--- IMU ------------------------------------------
    ...
    armarPaquete(angulo, acel_lateral_g, ax, ay, az, gx, gy, gz,
                 dx1, dx2, dx3, dx4, dx5, cambio_confirmado, tiempo_actual, presion1, presion2);
