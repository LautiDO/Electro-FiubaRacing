  ...
  if (tiempo_actual - tiempo_previo_us >= PERIODO_MUESTREO_US) {
    ...
    if (imu_online) {
      if (imuResponde()) {
        ...
        calcularFuerzasG(a.acceleration.x, a.acceleration.y, a.acceleration.z,
                          acel_lateral_g, acel_long_g);
        ...
        Serial.print("Angulo:"); Serial.print(angulo_vector); Serial.print(" ");
